...
pub fn make_builder() -> Builder<tauri::Wry> {
    Builder::<tauri::Wry>::new().commands(collect_commands![
        ...
        toolbox::netdiag::netdiag_local,
        toolbox::netdiag::netdiag_default_targets,
        toolbox::netdiag::netdiag_check_services,
        toolbox::netdiag::netdiag_save_snapshot,
        toolbox::netdiag::netdiag_list_snapshots,
        toolbox::netdiag::netdiag_get_snapshot,
