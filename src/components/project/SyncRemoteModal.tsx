...
import { X, Database, Plus, AlertCircle, CheckCircle } from "lucide-react";
          ...
          {syncResult && (
            <div className="mt-4 p-4 bg-green-50 border border-green-200 rounded-lg">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-semibold text-green-700">同步成功</span>
              </div>
              <div className="text-xs text-green-700 whitespace-pre-wrap pl-6">
                {syncResult}
              </div>
            </div>
          )}
